...
public class MainPanel extends JPanel
{
    ...
    public MainPanel(final int levelEditorCellRows, final int levelEditorCellCols, final int cellSize)
    {
        ...
        levelEditorPanel = new LevelEditorPanel(levelEditorCellRows, levelEditorCellCols, cellSize);
        ...
        resourcesScrollPane.setPreferredSize(new Dimension(148, 350));
        resourceAndComponentPanel.add(resourcesScrollPane, BorderLayout.NORTH);

        JPanel componentPanel = new ComponentsPanel();
        JScrollPane componentsScrollPane = new JScrollPane(componentPanel, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        componentsScrollPane.getVerticalScrollBar().setUnitIncrement(SCROLL_UNIT);
        componentsScrollPane.setPreferredSize(new Dimension(148, 350));
